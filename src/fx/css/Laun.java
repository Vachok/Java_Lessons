...
public class Laun extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        flowPane.getChildren().add(new ChoiceBox<>(FXCollections.observableArrayList("First", "Second", "Third")));
        ...
        link.setOnAction(event -> System.out.println("Link Click!"));
        ...
        button.setOnAction(event -> fileChooser.showOpenDialog(primaryStage));
