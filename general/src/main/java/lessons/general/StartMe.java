...
import lessons.general.externalizer.ExternAliz;
import lessons.general.grasppat.GRASPPattern;
...
import lessons.general.hiloadarch.HiLoadClasse;
import lessons.general.immuclasses.ImClass;
...
public class StartMe implements Lessons {
    private static Lessons lessons = new ThrLocal();
